...
*A copy of the presentation given in the first lecture can be found <a href="IntroLecture.pdf" download>here</a>.*
...
* appreciating the importance of co-ordinated teamwork and project management.
* applying and integrating the engineering principles taught in Part I.
* understand how to produce detailed design proposals.
* gaining experience of building and testing a system once it has been designed.
...
Full details of the available parts and datasheets can be found on the Moodle site which can be found [here](https://www.vle.cam.ac.uk/course/view.php?id=163282).
...
Detailed requirements and examples of the materials which must be submitted can be found [here](assesment.md).  Reports and presentations should be submitted online on the IDP Moodle Page.
